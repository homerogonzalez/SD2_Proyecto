...
-- Design Ports Information
-- F[0]	=>  Location: PIN_B7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[1]	=>  Location: PIN_C8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[2]	=>  Location: PIN_B1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[3]	=>  Location: PIN_F7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[4]	=>  Location: PIN_D6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- F[7]	=>  Location: PIN_C2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- selec[0]	=>  Location: PIN_A2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- selec[1]	=>  Location: PIN_E9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- selec[2]	=>  Location: PIN_D7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- A[5]	=>  Location: PIN_H11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF ALU_PROC_PARA IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \auxf[8]~35_combout\ : std_logic;
...
SIGNAL auxf : std_logic_vector(8 DOWNTO 0);
...
-- Equation(s):
-- \auxf~2_combout\ = (\auxf~0_combout\ & (\selec[2]~input_o\ $ (\selec[0]~input_o\ $ (\selec[1]~input_o\)))) # (!\auxf~0_combout\ & (\selec[1]~input_o\ & ((\selec[0]~input_o\) # (!\selec[2]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011010101001000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \auxf~4_combout\ = (\selec[2]~input_o\ & (\A[0]~input_o\)) # (!\selec[2]~input_o\ & ((\A[1]~input_o\)))
...
-- Equation(s):
-- \auxf~5_combout\ = (\selec[1]~input_o\ & ((\selec[2]~input_o\ & ((\B[1]~input_o\))) # (!\selec[2]~input_o\ & (!\auxf~4_combout\)))) # (!\selec[1]~input_o\ & (\auxf~4_combout\ & ((\selec[2]~input_o\) # (\B[1]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011110000100100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \selec[2]~input_o\,
	datab => \selec[1]~input_o\,
	datac => \auxf~4_combout\,
	datad => \B[1]~input_o\,
...
-- Equation(s):
-- \auxf~6_combout\ = (\selec[1]~input_o\ & (((\selec[2]~input_o\)))) # (!\selec[1]~input_o\ & ((\selec[2]~input_o\ & ((\A[2]~input_o\))) # (!\selec[2]~input_o\ & (\Add0~2_combout\))))
...
-- Equation(s):
-- \auxf~7_combout\ = (\selec[1]~input_o\ & ((\B[1]~input_o\ & ((!\A[1]~input_o\) # (!\auxf~6_combout\))) # (!\B[1]~input_o\ & ((\A[1]~input_o\))))) # (!\selec[1]~input_o\ & (((\auxf~6_combout\))))
...
-- Equation(s):
-- \auxf~8_combout\ = (\selec[0]~input_o\ & (\auxf~5_combout\)) # (!\selec[0]~input_o\ & ((\auxf~7_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \auxf~5_combout\,
	datac => \selec[0]~input_o\,
	datad => \auxf~7_combout\,
...
-- Equation(s):
-- \auxf~9_combout\ = (\A[2]~input_o\ & (\selec[0]~input_o\ $ (((!\selec[2]~input_o\) # (!\B[2]~input_o\))))) # (!\A[2]~input_o\ & ((\B[2]~input_o\) # ((\selec[0]~input_o\ & !\selec[2]~input_o\))))
...
-- Equation(s):
-- \auxf~10_combout\ = (\A[2]~input_o\ & \B[2]~input_o\)
...
-- Equation(s):
-- \auxf~11_combout\ = (\selec[0]~input_o\ & (((\selec[2]~input_o\)))) # (!\selec[0]~input_o\ & ((\selec[2]~input_o\ & ((\A[3]~input_o\))) # (!\selec[2]~input_o\ & (\Add0~4_combout\))))
...
-- Equation(s):
-- \auxf~12_combout\ = (\auxf~11_combout\ & (((\A[1]~input_o\) # (!\selec[0]~input_o\)))) # (!\auxf~11_combout\ & (\auxf~10_combout\ & (\selec[0]~input_o\)))
...
-- Equation(s):
-- \auxf~39_combout\ = (\selec[2]~input_o\ & (\B[3]~input_o\ $ ((!\selec[1]~input_o\)))) # (!\selec[2]~input_o\ & ((\selec[1]~input_o\ & ((!\A[3]~input_o\))) # (!\selec[1]~input_o\ & (\B[3]~input_o\ & \A[3]~input_o\))))
...
-- Equation(s):
-- \auxf~40_combout\ = (\B[3]~input_o\ & ((\auxf~39_combout\) # ((\A[2]~input_o\ & \selec[2]~input_o\)))) # (!\B[3]~input_o\ & (\auxf~39_combout\ & ((\A[2]~input_o\) # (!\selec[2]~input_o\))))
...
-- Equation(s):
-- \auxf~14_combout\ = (\selec[1]~input_o\ & (((\selec[2]~input_o\)))) # (!\selec[1]~input_o\ & ((\selec[2]~input_o\ & ((\A[4]~input_o\))) # (!\selec[2]~input_o\ & (\Add0~6_combout\))))
...
-- Equation(s):
-- \auxf~15_combout\ = (\selec[1]~input_o\ & ((\B[3]~input_o\ & ((!\auxf~14_combout\) # (!\A[3]~input_o\))) # (!\B[3]~input_o\ & (\A[3]~input_o\)))) # (!\selec[1]~input_o\ & (((\auxf~14_combout\))))
...
-- Equation(s):
-- \auxf~16_combout\ = (\selec[0]~input_o\ & (\auxf~40_combout\)) # (!\selec[0]~input_o\ & ((\auxf~15_combout\)))
...
-- Equation(s):
-- \auxf~19_combout\ = (\selec[2]~input_o\ & (((\selec[0]~input_o\) # (\A[5]~input_o\)))) # (!\selec[2]~input_o\ & (\Add0~8_combout\ & (!\selec[0]~input_o\)))
...
-- Equation(s):
-- \auxf~18_combout\ = (\B[4]~input_o\ & \A[4]~input_o\)
...
-- Equation(s):
-- \auxf~20_combout\ = (\auxf~19_combout\ & (((\A[3]~input_o\) # (!\selec[0]~input_o\)))) # (!\auxf~19_combout\ & (\auxf~18_combout\ & (\selec[0]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \auxf~19_combout\,
	datab => \auxf~18_combout\,
	datac => \selec[0]~input_o\,
	datad => \A[3]~input_o\,
...
-- Equation(s):
-- \auxf~17_combout\ = (\A[4]~input_o\ & (\selec[0]~input_o\ $ (((!\selec[2]~input_o\) # (!\B[4]~input_o\))))) # (!\A[4]~input_o\ & ((\B[4]~input_o\) # ((\selec[0]~input_o\ & !\selec[2]~input_o\))))
...
-- Equation(s):
-- \auxf~21_combout\ = (\selec[1]~input_o\ & ((\auxf~17_combout\))) # (!\selec[1]~input_o\ & (\auxf~20_combout\))
...
-- Equation(s):
-- \auxf~37_combout\ = (\selec[2]~input_o\ & (\selec[1]~input_o\ $ ((!\B[5]~input_o\)))) # (!\selec[2]~input_o\ & ((\selec[1]~input_o\ & ((!\A[5]~input_o\))) # (!\selec[1]~input_o\ & (\B[5]~input_o\ & \A[5]~input_o\))))
...
-- Equation(s):
-- \auxf~38_combout\ = (\B[5]~input_o\ & ((\auxf~37_combout\) # ((\A[4]~input_o\ & \selec[2]~input_o\)))) # (!\B[5]~input_o\ & (\auxf~37_combout\ & ((\A[4]~input_o\) # (!\selec[2]~input_o\))))
...
-- Equation(s):
-- \auxf~22_combout\ = (\selec[1]~input_o\ & (((\selec[2]~input_o\)))) # (!\selec[1]~input_o\ & ((\selec[2]~input_o\ & ((\A[6]~input_o\))) # (!\selec[2]~input_o\ & (\Add0~10_combout\))))
...
-- Equation(s):
-- \auxf~23_combout\ = (\selec[1]~input_o\ & ((\B[5]~input_o\ & ((!\A[5]~input_o\) # (!\auxf~22_combout\))) # (!\B[5]~input_o\ & ((\A[5]~input_o\))))) # (!\selec[1]~input_o\ & (((\auxf~22_combout\))))
...
-- Equation(s):
-- \auxf~24_combout\ = (\selec[0]~input_o\ & (\auxf~38_combout\)) # (!\selec[0]~input_o\ & ((\auxf~23_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \auxf~38_combout\,
	datac => \selec[0]~input_o\,
	datad => \auxf~23_combout\,
...
-- Equation(s):
-- \auxf~27_combout\ = (\selec[2]~input_o\ & ((\selec[0]~input_o\) # ((\A[7]~input_o\)))) # (!\selec[2]~input_o\ & (!\selec[0]~input_o\ & (\Add0~12_combout\)))
...
-- Equation(s):
-- \auxf~26_combout\ = (\A[6]~input_o\ & \B[6]~input_o\)
...
-- Equation(s):
-- \auxf~28_combout\ = (\auxf~27_combout\ & (((\A[5]~input_o\)) # (!\selec[0]~input_o\))) # (!\auxf~27_combout\ & (\selec[0]~input_o\ & ((\auxf~26_combout\))))
...
-- Equation(s):
-- \auxf~25_combout\ = (\A[6]~input_o\ & (\selec[0]~input_o\ $ (((!\selec[2]~input_o\) # (!\B[6]~input_o\))))) # (!\A[6]~input_o\ & ((\B[6]~input_o\) # ((!\selec[2]~input_o\ & \selec[0]~input_o\))))
...
-- Equation(s):
-- \auxf~29_combout\ = (\selec[1]~input_o\ & ((\auxf~25_combout\))) # (!\selec[1]~input_o\ & (\auxf~28_combout\))
...
-- Equation(s):
-- \auxf~30_combout\ = (\selec[1]~input_o\ & ((\selec[0]~input_o\ & (\selec[2]~input_o\)) # (!\selec[0]~input_o\ & (!\selec[2]~input_o\ & \B[7]~input_o\)))) # (!\selec[1]~input_o\ & ((\selec[2]~input_o\) # ((\selec[0]~input_o\ & !\B[7]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1101001011010100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \selec[1]~input_o\,
...
-- Equation(s):
-- \auxf~31_combout\ = (\selec[1]~input_o\ & (\selec[0]~input_o\ $ (((\selec[2]~input_o\ & \B[7]~input_o\))))) # (!\selec[1]~input_o\ & (\selec[0]~input_o\ & ((\selec[2]~input_o\) # (\B[7]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110110011001000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \selec[1]~input_o\,
...
-- Equation(s):
-- \auxf~33_combout\ = (\auxf~31_combout\ & (\selec[1]~input_o\ $ (((\auxf~30_combout\) # (\A[7]~input_o\))))) # (!\auxf~31_combout\ & (\selec[1]~input_o\ & ((\auxf~30_combout\) # (\A[7]~input_o\))))
...
-- Equation(s):
-- \auxf~32_combout\ = (\selec[1]~input_o\ & (\auxf~31_combout\ $ (((!\auxf~30_combout\ & !\A[7]~input_o\))))) # (!\selec[1]~input_o\ & ((\auxf~30_combout\) # ((\auxf~31_combout\ & !\A[7]~input_o\))))
...
-- Equation(s):
-- \auxf~34_combout\ = (\auxf~33_combout\ & (((\A[6]~input_o\) # (!\auxf~32_combout\)))) # (!\auxf~33_combout\ & (\Add0~14_combout\ & ((!\auxf~32_combout\))))
...
PORT MAP (
	...
	datab => \auxf~33_combout\,
	datac => \A[6]~input_o\,
	datad => \auxf~32_combout\,
	combout => \auxf~34_combout\);

-- Location: LCCOMB_X27_Y37_N8
\auxf[8]~35\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \auxf[8]~35_combout\ = (!\selec[1]~input_o\ & ((\A[7]~input_o\) # (!\selec[2]~input_o\)))
...
-- Equation(s):
-- \auxf[8]~36_combout\ = (\auxf[8]~35_combout\ & ((\selec[2]~input_o\ & ((\selec[0]~input_o\))) # (!\selec[2]~input_o\ & (\Add0~16_combout\ & !\selec[0]~input_o\))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!\selec[2]~input_o\ & (\selec[1]~input_o\ & \selec[0]~input_o\))
...
\auxf[8]\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- auxf(8) = (\Equal0~0_combout\ & (auxf(8))) # (!\Equal0~0_combout\ & ((\auxf[8]~36_combout\)))
...
-- Equation(s):
-- \Z~0_combout\ = (\auxf~3_combout\) # ((\selec[0]~input_o\ & (\auxf~5_combout\)) # (!\selec[0]~input_o\ & ((\auxf~7_combout\))))
...
PORT MAP (
	...
	datac => \selec[0]~input_o\,
	datad => \auxf~3_combout\,
	combout => \Z~0_combout\);

-- Location: LCCOMB_X26_Y36_N8
\Z~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Z~1_combout\ = (\auxf~16_combout\) # ((\auxf~13_combout\) # ((\auxf~21_combout\) # (\Z~0_combout\)))
...
-- Equation(s):
-- \Z~2_combout\ = (\auxf~29_combout\) # ((\Z~1_combout\) # ((\auxf~34_combout\) # (\auxf~24_combout\)))
...
PORT MAP (
	...
	datab => \Z~1_combout\,
	datac => \auxf~34_combout\,
	datad => \auxf~24_combout\,
	combout => \Z~2_combout\);
